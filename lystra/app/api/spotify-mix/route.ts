...
import { candidateKey, dedupeById, fetchLastfmCandidates, resolveTracks, type DeezerTrack } from '@/lib/deezerPreview';
...
export async function GET(request: Request) {
  ...
  try {
    ...
    let fallbackTracks: DeezerTrack[] = [];
    ...
    const finalTracks = allTracks.map((track: DeezerTrack) => ({
      id: String(track.id),
      title: track.title,
