...
const CORS_PATHS = ['/api/tg/', '/api/favorites', '/api/genres/', '/api/spotify-mix', '/api/mobile/profile', '/api/new-releases', '/api/random-release', '/api/genre-release', '/api/release-by-id']
